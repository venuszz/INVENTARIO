    ...
    const fetchMuebles = useCallback(async () => {
        ...
        try {
            ...
            setLoadingProgress({
                count: 0,
                total: totalInTable,
                message: `Preparando carga de ${totalInTable.toLocaleString()} registros...`
            });
            ...
            while (keepFetching) {
                ...
                if (data && data.length > 0) {
                    ...
                    setLoadingProgress({
                        ...
                        total: totalInTable,
                        message: `Cargando ${allData.length.toLocaleString()} de ${totalInTable.toLocaleString()} registros...`
                    });
                                            ...
                                            paginatedMuebles.map((item, idx) => {
                                                ...
                                                return (
                                                    <tr
                                                        ...
                                                        className={`group transition-all duration-300 cursor-pointer animate-fadeInUp ${selectedItem?.id === item.id
