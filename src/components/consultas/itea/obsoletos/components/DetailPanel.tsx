...
function ViewMode({
  ...
  // Load field history
  const { fieldsWithHistory, fieldHistory, loading } = useFieldHistory(selectedItem?.id || null, 'mueblesitea');
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <DetailCard label="ID Inventario" value={selectedItem.id_inv} isDarkMode={isDarkMode} idMueble={selectedItem.id} fieldName="id_inv" hasHistory={fieldsWithHistory['id_inv']} fieldHistory={fieldHistory} />
        <DetailCard label="Rubro" value={selectedItem.rubro || 'No especificado'} isDarkMode={isDarkMode} idMueble={selectedItem.id} fieldName="rubro" hasHistory={fieldsWithHistory['rubro']} fieldHistory={fieldHistory} />
        <DetailCard label="Descripción" value={selectedItem.descripcion || 'No especificado'} isDarkMode={isDarkMode} colSpan2 idMueble={selectedItem.id} fieldName="descripcion" hasHistory={fieldsWithHistory['descripcion']} fieldHistory={fieldHistory} />
        <DetailCard 
          label="Valor" 
        ...
        <DetailCard label="Estatus" value={selectedItem.config_estatus?.concepto || selectedItem.estatus || 'No especificado'} isDarkMode={isDarkMode} idMueble={selectedItem.id} fieldName="id_estatus" hasHistory={fieldsWithHistory['id_estatus']} fieldHistory={fieldHistory} />
        ...
        <DetailCard label="Director/Jefe de Área" value={isSyncing ? null : (selectedItem.directorio?.nombre || 'No especificado')} isDarkMode={isDarkMode} isSyncing={isSyncing} idMueble={selectedItem.id} fieldName="id_directorio" hasHistory={fieldsWithHistory['id_directorio']} fieldHistory={fieldHistory} />
      </div>
    </div>
  );
}
