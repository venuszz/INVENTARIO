...
import { truncateText, getStatusBadgeColors } from '../utils';
                            ...
                            <tr className="h-96">
                                <td colSpan={6} className={`px-6 py-24 text-center ${
                                    ...
                                    <div className="flex flex-col items-center justify-center space-y-4">
                                        ...
                                        <p className="text-lg font-light">No se encontraron artículos no listados</p>
                                        <p className={`text-sm ${
                                            ...
                                            {(() => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        {status === 'NO LOCALIZADO' && <AlertTriangle className="h-3 w-3" />}
