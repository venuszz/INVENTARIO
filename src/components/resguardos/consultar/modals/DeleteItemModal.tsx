...
import { X, CircleX, FileText, Loader2 } from 'lucide-react';
            ...
            <div className="p-6">
              ...
              <div className={`rounded-lg border p-3 mb-4 ${
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`text-sm font-mono font-medium ${isDarkMode ? 'text-white' : 'text-black'}`}>
              ...
              <div className={`rounded-lg border p-3 mb-4 ${
                ...
                <p className={`text-xs ${
                  ...
                  El bien quedará libre para asignarse nuevamente. Se eliminará el responsable y área del registro original.
                </p>
              </div>
