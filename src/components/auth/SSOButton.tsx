...
export default function SSOButton({ onError, disabled = false, ssoUrl }: SSOButtonProps) {
    ...
    return (
        <button
            ...
            className={`group relative w-full py-5 px-8 rounded-2xl font-bold transition-all duration-700 flex items-center justify-between overflow-hidden transform active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed ${
                isDarkMode
